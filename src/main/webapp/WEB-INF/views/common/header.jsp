...
<div id="header-wrap">
    <div class="top-wrap">
        <div class="inner-box" id="tip-box-top">
            <!-- 로고 -->
            <a href="/index.do" class="btn-logo">
            ...
            <div class="util-nav">
                ...
                <a href="/member/regist1.do">회원가입</a>
                <a href="/order/cart.do"><span class="material-icons-outlined">shopping_cart</span></a>
            </div>
			</sec:authorize>
            ...
            <a><form:form method="post" action="${pageContext.request.contextPath}/member/logout">
	            ...
	            <a href="/mypage/myMain.do">마이페이지</a>
	            <a href="/order/cart.do"><span class="material-icons-outlined">shopping_cart</span></a>
            </div>
            </sec:authorize>
        </div>
    ...
    <div id="gnb" class="gnb-wrap">
        <div class="gnb-inner" align="middle">
            <ul>
                <li>
                    <a href="/order/orderDIY.do"><span>주문하기</span></a>
                </li>
                <li>
                    <a href="/community/review.do"><span>커뮤니티</span></a>
                </li>
                <li>
                    <a href="/company/intro.do"><span>회사소개</span></a>
                </li>
            </ul>
        ...
        <div class="snb-wrap">
            <div class="inner-box">
                <div class="mnu-wrap">
                    <div class="mnu-box">
                        ...
                        <ul>
                            ...
                            <li><a href="/order/orderNormal.do">일반피자</a></li>
                    ...
                    <div class="mnu-box">
                        <!-- <a href="#">매장소개</a> -->
                        <ul>
                            <li><a href="/company/intro.do">FreeP</a></li>
                ...
                <div class="notice-box">
                    <ul>
                        <li><a href="/etc/faq.do">FAQ</a></li>
                        <li><a href="/etc/franInquiry.do">가맹문의</a></li>
                    </ul>
                </div>
            </div>
        </div>
